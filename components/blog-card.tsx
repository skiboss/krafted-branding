  ...
  if (featured) {
    return (
      <Link href={`/blog/${post.slug}`}>
        <Card className="relative overflow-hidden cursor-pointer group h-96 md:h-80">
          ...
          <CardContent className="relative z-10 h-full flex flex-col justify-end p-6 text-white">
            ...
            <p className="text-gray-200 text-sm md:text-base leading-relaxed">{post.excerpt}</p>
          </CardContent>
        </Card>
      </Link>
    )
